...
from streamlit_chat import message as messageDisplay
...
- Don't add "Based on the information provided in the conversation log and the knowledge base" in your responses.
...
if st.session_state.start_chat:
    ...
    for message in st.session_state.messages:
        ...
        if message["role"] == "user":
            ...
            messageDisplay(message["content"],key=str(message["content"])+"user"+getRandom(),is_user=True)

        else:
            messageDisplay(message["content"],key=str(message["content"])+getRandom())
    ...
    if chat_input := st.chat_input("Ask..."):
        ...
        messageDisplay(chat_input,key=str(chat_input)+getRandom(),is_user=True)
                # message(st.session_state['openai_response'][i], avatar_style="miniavs",is_user=True,key=str(i) + 'data_by_user')
        
        # with st.chat_message("user"):
        #     st.markdown(chat_input)
        messageDisplay(ai_response,key=str(ai_response)+getRandom())
